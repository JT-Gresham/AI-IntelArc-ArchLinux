...
#### Executable below
echo "ipexrun xpu $pdirectory/AI-IntelArc-ArchLinux/forge-IntelArc-ArchLinux/launch.py --skip-torch-cuda-test \"\$@\"" >> $pdirectory/AI-IntelArc-ArchLinux/$aiiaalpkg-IntelArc-ArchLinux/$aiiaalpkg-Start.sh
echo "" >> $pdirectory/AI-IntelArc-ArchLinux/$aiiaalpkg-IntelArc-ArchLinux/$aiiaalpkg-Start.sh
